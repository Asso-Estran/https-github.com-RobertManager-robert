...
<body>
		...
		<?php
				...
				foreach ( $retour['sousPlans'] as $sp ){
					...
					foreach( $tekosExp as $tek){
						...
						if ( !isset($listeTeks[$tek]['nbJoursTaf']) ) $listeTeks[$tek]['nbJoursTaf'] =0 ;
						$listeTeks[$tek]['nbJoursTaf'] ++ ;
						if ( ! @$listeTeks[$tek]['tel_print'] )
							$tekDiv .= '<div class="tekName padH5">
	...
	<div id='benefInfo' class='ui-widget titreSection bordFin ui-corner-all'>
		...
		<?php
			...
			else { echo '<span class="ui-state-disabled"><i>aucun interlocuteur spécifié pour cette structure bénéficiaire.</i></span><br /><br />'; }
		?>
		</div>
	</div>
	...
	<div id='planDecla' class='ui-widget titreSection pageBreakBefore bordFin ui-corner-all'>
		...
		<?php
						...
						if ( ! @$listeTeks[$tek]['print_decla'] ){
							...
							$declaDiv .= '<div class="tekName padH5 marge30l">
											...
											<div class="inline">
													  ...
													  TOTAL : <div class="nbBrouzGlobal gras inline rightText" style="width:35px;">'.($listeTeks[$tek]['nbJoursTaf'] * 160).'</div> F '.$entrepriseNote.'
											</div>';
			...
			<div class="tekName padH5 marge30r rightText enorme">
				...
				TOTAL : <span class='totalDecla'><?php echo number_format($defaultTotalDecla, 2, '.', ''); ?></span> F
			</div>
		</div>
